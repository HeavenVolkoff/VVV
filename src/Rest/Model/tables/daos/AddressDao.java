...
public class AddressDao extends DAOImpl<AddressRecord, Rest.Model.tables.pojos.Address, Integer> {
	...
	/**
	 * Fetch records that have <code>complement IN (values)</code>
	 */
	public List<Rest.Model.tables.pojos.Address> fetchByComplement(String... values) {
		return fetch(Address.ADDRESS.COMPLEMENT, values);
	}
